...
def print_help():
    ...
    PARAM.append("HPC_SYSTEM");                     VARTYP.append("str");           DETAILS.append("Job scheduler on machine code is launched on (only \"slurm\" , \"conda-slurm\", \"TACC\" and \"UM-ARC\" are supported currently)")
