...
#### WARNING: SUPPORT ONLY FOR CHEBY INTERACTIONS; NO CHARGE FITTING; FIXED CHARGES OK
...
class atm_types_block:
	...
	def set_block(self,param_data):
		...
		for i in xrange(int(self.ntype)):
...
class pair_types_block:
	...
	def set_block(self,param_data):
		...
		for i in xrange(int(self.npair)):
			line = param_data[type_line+i].split()
...
class params_2b:
	...
	def set_block(self,param_data):
		...
		for i in xrange(int(self.order)):
...
class params_3b_block:
	...
	def set_block(self,param_data):
		...
		for i in xrange(int(self.ntrips)):
...
class params_4b_block:
	...
	def set_block(self,param_data):
		...
		for i in xrange(int(self.nquads)):
...
class param_file():
	...
	def update_from(self, other):
		...
		for i in xrange(int(self.atm_types_block.ntype)):
		...
		for i in xrange(int(self.pair_types_block.npair)):
			for j in xrange(int(other.pair_types_block.npair)):
		...
		if other.s3b_block.number is not None:
			...
			for i in xrange(int(other.s3b_block.number)):
			
				found_match = False
			
				for j in xrange(int(self.s3b_block.number)):
		...
		if other.s4b_block.number is not None:
			...
			for i in xrange(int(other.s4b_block.number)):
			
				found_match = False
			
				for j in xrange(int(self.s4b_block.number)):
		...
		for i in xrange(int(other.params_2b.npair)):
			
			for j in xrange(int(self.params_2b.npair)):
		...
		for i in xrange(int(other.params_3b.ntrips)):
			for j in xrange(int(self.params_3b.ntrips)):
				...
				if other.params_3b.par3b[i].atms == self.params_3b.par3b[j].atms:
					...
					if self.params_3b.par3b[j].excl: # This was an excluded type - need to update ALL associated info
						...
						if not other.params_3b.par3b[i].excl:
							...
							for k in xrange(int(other.maps_3b.ntrip)):
								for l in xrange(int(self.maps_3b.ntrip)):
					...
					for k in xrange(int(other.params_3b.par3b[i].npar)):
		...
		for i in xrange(int(other.params_4b.nquads)):
			for j in xrange(int(self.params_4b.nquads)):
				...
				if other.params_4b.par4b[i].atms == self.params_4b.par4b[j].atms:
					...
					if self.params_4b.par4b[j].excl: # This was an excluded type - need to update ALL associated info: # This was an excluded type - need to update ALL associated info
						...
						if not other.params_4b.par4b[i].excl:					
							...
							for k in xrange(int(other.maps_4b.nquad)):
								for l in xrange(int(self.maps_4b.nquad)):
					...
					for k in xrange(int(other.params_4b.par4b[i].npar)):
		...
		if int(self.eoffset_block.number) == 0: # Then need to set up template
			...
			for i in xrange(int(self.eoffset_block.number)):
		...
		for j in xrange(int(other.eoffset_block.number)):
